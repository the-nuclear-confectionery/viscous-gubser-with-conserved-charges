...
The following scripts were used to produce the figures in [Phys. Rev. C **113** (2026) 2, 024915 (2025)](https://doi.org/10.1103/v334-d32w), [arXiv:2503:20021 [nucl-th]](https://arxiv.org/abs/2503.20021). The scripts all together using the [plot_vgcc.py](../plot_vgcc.py), i.e., running the command
