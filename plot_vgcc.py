...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--analytical_path", default="data/output/analytic_solutions/EoS2",
                        help="folder containing the analytical solutions.")
    parser.add_argument("--simulation_path", default="data/CCAKE_results/",
...
def main():
    ...
    scripts_to_run = [
        ...
        },
        {
            ...
            "args": ["--analytical_path", args.analytical_path, "--simulation_path", args.simulation_path, "--output_path", "data/output/plots/"]
        },
        {
            "script": os.path.join("plots", "plot_Fig5_CCAKE_vs_VGCC_hypersurface.py"),
            "args": ["--simulation_path", args.simulation_path, "--output_path", "data/output/plots/", "--debug"]
        }
    ]
